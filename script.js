document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            dir: 'ltr',
            'nav-home': 'Home', 'nav-products': 'Products', 'nav-departments': 'Department', 'nav-about': 'About Us', 'nav-contact': 'Contact', 'nav-special-text': 'Bazaar',
        ...
        fa: {
            dir: 'rtl',
            'nav-home': 'خانه', 'nav-products': 'محصولات', 'nav-departments': 'دپارتمان', 'nav-about': 'درباره ما', 'nav-contact': 'تماس با ما', 'nav-special-text': 'بازار',
        ...
        ar: {
            dir: 'rtl',
            'nav-home': 'الرئيسية', 'nav-products': 'المنتجات', 'nav-departments': 'قسم', 'nav-about': 'من نحن', 'nav-contact': 'اتصل بنا', 'nav-special-text': 'بازار',
        ...
        ru: {
            dir: 'ltr',
            'nav-home': 'Главная', 'nav-products': 'Продукция', 'nav-departments': 'Отдел', 'nav-about': 'О нас', 'nav-contact': 'Контакты', 'nav-special-text': 'Базар',
