document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            'nav-home': 'Home', 'nav-products': 'Products', 'nav-departments': 'Department', 'nav-about': 'About Us', 'nav-contact': 'Contact', 'nav-transport': 'Loading & Transport Services',
        ...
        fa: {
            ...
            'nav-home': 'خانه', 'nav-products': 'محصولات', 'nav-departments': 'دپارتمان', 'nav-about': 'درباره ما', 'nav-contact': 'تماس با ما', 'nav-transport': 'خدمات بارگیری و حمل‌ونقل',
        ...
        ar: {
            ...
            'nav-home': 'الرئيسية', 'nav-products': 'المنتجات', 'nav-departments': 'قسم', 'nav-about': 'من نحن', 'nav-contact': 'اتصل بنا', 'nav-transport': 'خدمات التحميل والنقل',
        ...
        ru: {
            ...
            'nav-home': 'Главная', 'nav-products': 'Продукция', 'nav-departments': 'Отдел', 'nav-about': 'О нас', 'nav-contact': 'Контакты', 'nav-transport': 'Погрузка и перевозка',
...
const mainFooter = document.getElementById('mainFooter');
    ...
    // لینک‌های صفحات مستقل را پس از بازگشت به نمای درست سایت هدایت می‌کند.
    const initialHash = window.location.hash;
    window.requestAnimationFrame(() => {
        if (initialHash === '#catalogSectionAnchor') {
            showMainLanding();
            setActiveNavLink('navProductsLink');
            window.requestAnimationFrame(() => {
                document.getElementById('catalogSectionAnchor')?.scrollIntoView({ behavior: 'auto', block: 'start' });
            });
        } else if (initialHash === '#about' || initialHash === '#aboutUsView') {
            showAboutUs();
        } else if (initialHash === '#departments' || initialHash === '#departmentsView') {
            showDepartments();
        } else if (initialHash === '#contactView') {
            showContactUs();
        } else if (initialHash === '#specialSaleView') {
            showSpecialSale();
        }
    });
